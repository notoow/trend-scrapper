...
3. 콘텐츠 가치 점수 (content_score: 0~100 사이 정수):
   ...
   - **중요**: 학술 연구(논문)일지라도 **남성의 짝짓기 경쟁, 성형수술 선택 심리(음경확대술 등), 동성 사회적 자신감/우월함 추구 심리(Superiority Enjoyment), 또는 성 건강/성행위 행동 패턴 등 '남성 비뇨의학과 수술이나 성(Sex) 심리'에 직접 연관되는 사회심리학/인류학 연구는 대중이 흥미를 느끼기 매우 좋은 킬러 소재이므로 무조건 90~100점의 고점**을 부여해야 합니다.
   - **90~100점**: 보형물 만족도, 확대수술 전후 사례, 여유증 수술 전후, 가십성 셀럽 비뇨의학 뉴스, 남성 성/수술 선택 심리 분석 논문 등 조회수 폭발 소재.
   ...
   - **0~29점**: 세포 단위 실험, 동물(쥐) 실험, 분자 생물학적 기전 연구(예: "Wnt/β-catenin 신호 경로"), 단순 기초 학술용 자료.

4. 유튜브 기획 자산 생성 (핵심):
   - 이 뉴스를 바탕으로 유튜브 영상을 기획한다고 가정하고 아래 3가지 항목을 제작하세요:
     - `youtube_title`: 시청자의 호기심을 극대화하며 주제를 명확히 표현하는 **유튜브 영상 제목** (예: "남자가 성기 확대 수술을 결정하는 진짜 심리 (단순히 작아서가 아닙니다)")
     - `thumbnail_text`: 유튜브 썸네일에 들어갈 4~8글자 내외의 강렬한 **썸네일 카피 문구** (예: "작아서 한다?", "가슴 나온 남자 필독")
     - `internal_title`: 병원 마케팅 목적을 고려한 **영상 기획 의도** (예: "확대수술 환자의 우월감 추구 심리를 자극하여 내원을 유도하는 영상 기획")
...
{{
  ...
  "thumbnail_text": "썸네일 카피",
  "internal_title": "영상 기획 의도"
}}
"""
...
5. 유튜브 기획:
   - `youtube_title`: 시청자의 호기심을 극대화하며 주제를 명확히 표현하는 **유튜브 영상 제목**
   - `thumbnail_text`: 썸네일에 들어갈 4~8글자 내외의 강렬한 **썸네일 카피 문구**
   - `internal_title`: 병원 마케팅 목적을 고려한 **영상 기획 의도**
